            ...
            <div class="box">
                ...
                <form action="servletCadastro" method="POST">
                    <fieldset>
                        ...
                        <label>Senha</label>
                        <input type="text" name="senha" minlength="8" maxlength="50" placeholder="Digite sua senha" required class="senha form-control">
                        <label>Confirmar senha</label>
                        <input type="text" name="confirmarSenha" minlength="8" maxlength="50" placeholder="Digite a mesma senha" required class="confirmar_senha form-control">
                    </fieldset>
